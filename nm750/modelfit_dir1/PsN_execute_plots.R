...
#Created 2026-06-06 at 12:31

xpose.runno <- '5.mod'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/nonmem/models/modelfit_dir1/'
results.directory <- '../models'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/local/share/perl/5.26.1/PsN_5_7_1/R-scripts' # This is not used
raw.results.file <- 'raw_results_CONTROL5.csv'

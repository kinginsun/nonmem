...
!      REPLACED LINE, RJB NM75A2 5/2018
!  INTENT HERE IS TO AVOID THE ADVAN FROM SPLITTING UP THE INTERVAL, AND LEAVE 
! THE CONTROL OF INTERVAL SETTING COMPLETELY WITHIN SADVAN.
!          DT=(DT+IDA(IF))/TWO
          DT=DMIN1((DT+IDA(IF))/TWO,IDA(IF))
...
!      
      ...
      END IF
!      
!    FOLLOWING CORRECTED BY RJB, 5/2018. NM75A2
!      TSTATE=TSTART+DELTA      
       TSTATE=TSTART+DT
!      
  999 RETURN 
